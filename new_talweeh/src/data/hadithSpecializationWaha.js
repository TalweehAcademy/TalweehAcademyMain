// Hadith Specialization data for the Wāḥa page (/hadith-specialization) — the courses with their overviews
// and learning outcomes, hero and overview copy, instructors and enrolment email, from the previous
...
export const HADITH = {
  "HERO": {
    "eyebrow": "Two-year advanced program",
    "name": "Takhaṣṣuṣ fī al-Ḥadīth",
    "lead": "A comprehensive two-year program for students seeking an in-depth understanding of the sciences of Hadith. The program moves from the historical development and preservation of the Sunnah into advanced study of Muṣṭalaḥ al-Ḥadīth, narrator evaluation, isnād analysis, hidden defects, and applied study of major Hadith collections."
  },
  "OVERVIEW": [
    "The introductory study traces Hadith from the time of the Prophet Muhammad ﷺ through the era of the noble Companions and their successors, establishing the historical foundation needed for detailed study of Hadith methodology.",
    "Students then progress through the disciplines of narrator criticism, transmission networks, takhrīj, chain analysis, scholarly indexes, hidden defects, modern critique, and applied readings. Each subject introduced in the early stages is revisited at greater depth so that theory and application develop together."
  ],
  "INSTRUCTORS": [
    [
      "Sheikh Omer Khurshid",
      "B.A., Faculty of Hadith, Islamic University of Madinah"
    ],
    [
      "Mufti Daud Khurshid",
      "Faculty of Islamic Law, Islamic University of Madinah"
    ]
  ],
  "ENROL": "mailto:info@talweehacademy.com?subject=Hadith%20Specialization%20Enrollment",
  "EMAIL": "info@talweehacademy.com",
  "COURSES": [
    {
      "n": 1,
      "year": 1,
    ...
    },
    {
      ...
      "overview": "This course provides an in-depth study of al-Suyūṭī’s extensive masterpiece Tadrīb al-Rāwī, one of the most comprehensive works on ḥadīth nomenclature. Building upon foundational principles, students explore the full spectrum of terminology, classifications, and technical discussions governing the authentication, transmission, and preservation of ḥadīth. The course emphasizes advanced applications through classical case studies and prepares students for higher-level ḥadīth research with methodological precision.",
      "outcomes": [
  ...
  "STRANDS": [
    {
      "k": "history",
      "label": "History & status of the Sunnah",
      "ar": "السُّنَّة"
    },
    {
      "k": "narrators",
      "label": "Narrators & their criticism",
      "ar": "الرُّوَاة"
    },
    {
      "k": "isnad",
      "label": "Chains of transmission",
      "ar": "الإِسْنَاد"
    },
    {
      "k": "method",
      "label": "Muṣṭalaḥ, methods & ʿilal",
      "ar": "المُصْطَلَح"
    },
    {
      "k": "sources",
      "label": "Sourcing & manuscripts",
      "ar": "المَصَادِر"
    },
    {
      "k": "critique",
      "label": "Modern critique",
      "ar": "النَّقْد"
    },
    {
      "k": "applied",
      "label": "Applied readings",
      "ar": "التَّطْبِيق"
    }
  ]
}
